    ...
    <div class="container-fluid h-100">
        <div class="row h-100">
            <div class="col-md-6 left-side d-flex flex-column align-items-center justify-content-center">
                <img src="../Polibatam.png" alt="Polibatam Logo" class="polibatam">
                ...
                <div class="login-box">
                    ...
                    <form action="login_process.php" method="POST">
                        <div class="form-group">
                            ...
                            <input name="nama_pengguna" type="text" class="form-control" id="username" placeholder="Masukkan Nama Pengguna">
                        </div>
                        <div class="form-group">
                            <label for="password">Kata Sandi</label>
                            <input name="password" type="password" class="form-control" id="password" placeholder="Masukkan Kata sandi">
                        </div>
                        <a href="../Otp/otp.php" class="d-block mb-3">Lupa Kata Sandi?</a>
