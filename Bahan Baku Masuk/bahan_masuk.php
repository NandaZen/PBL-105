...
include("koneksi.php");
$query = "SELECT * FROM t_bahan_baku_masukkeluar WHERE aksi = 'Bahan Baku Masuk'";
...
$query_table = "
   SELECT mk.id_bahan_masukkeluar AS id, bk.kode_barcode AS kode_barcode, bk.nama_bahan_baku AS nama_bahan, k.nama_kategori AS kategori, mk.kuantitas AS kuantitas, bk.unit AS unit, mk.tanggal AS tanggal, mk.aksi AS aksi, bk.id_bahan_baku AS id_bahan_baku FROM t_bahan_baku_masukkeluar mk INNER JOIN t_bahan_baku bk ON mk.id_bahan_baku = bk.id_bahan_baku INNER JOIN t_kategori k ON bk.id_kategori = k.id_kategori WHERE mk.aksi = 'Bahan Baku Masuk';
";
          ...
          <div class="modal-dialog">
            <div class="modal-content">      
              <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel"><strong>Tambahkan Stok Bahan Baku Masuk</strong></h5>
                ...
                <form action="simpan.php" method="POST">
                  <div class="mb-3">
                        <?php
                          ...
                          <select class="form-select" id="id_bahan_masukkeluar" name="id_bahan_masukkeluar">
